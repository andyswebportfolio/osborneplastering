...
<html>
    <head>
        <title>Osborne Plastering Eastbourne</title>
    ...
    <body>
        ...
        <div class="content_1"><hr class="long_hr"><br><br><h1>Welcome to Osborne Plastering</h1><br>
            <p>We offer a professional and friendly plastering service to private and commercial clients.<br>
            All Osborne Plastering work is carried out by our own trained applicators to the highest standards.<br><br>

            With a wealth of experience working throughout the UK and abroad you can rest assured of a high quality finish and professional service.<br>
            We provide an extremely unique and specialised plastering service with an extensive range of products we use.<br><br>

            We also carry out repairs to damaged ceilings and walls.<br>

            The main products that we use are: all types of British Gypsum, Catnic, Knauf, Monocouche, Rend Aid. </p>
        </div>
