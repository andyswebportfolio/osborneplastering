...
<html>
    ...
    <body>
        ...
        <div class="content_1"><hr class="long_hr"><br><br>
            <h1>Photo Gallery</h1>
            
        <div id="photo_gallery">
            <div class='embedsocial-album' data-ref="9fbeb57530925b825a4a414c0bc9b1c3c891861c" id="embed_social_1"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "embedSocial.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
            
            <div class='embedsocial-album' data-ref="9f69244f9a82829df62c6e61f0ab5bfa31c9abb8"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "embedSocial.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
            
            <div class='embedsocial-album' data-ref="b8c19f6ce07fd34949046df8899e5e54f0705c7b"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "embedSocial.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
            
            <div class='embedsocial-album' data-ref="c7f0e5a8ed1b205ba8c982f80129830d91228b0a"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "embedSocial.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialScript"));</script>
        </div>
